...
const translations = {
    'zh-CN': {
        ...
        'config.credsType.file': '文件路径',
        'config.credsType.base64': 'Base64编码',
        'config.credsBase64': 'OAuth凭据 (Base64)',
        'config.credsBase64Placeholder': '请输入Base64编码的OAuth凭据',
        ...
        'common.generate': '生成',
        'common.search': '搜索',
        'common.welcome': '欢迎使用 Kiro2API 管理控制台！',
    ...
    'en-US': {
        // Header
        'header.title': 'Kiro2API Management Console',
        ...
        'config.credsType.file': 'File Path',
        'config.credsType.base64': 'Base64 Encoded',
        'config.credsBase64': 'OAuth Credentials (Base64)',
        'config.credsBase64Placeholder': 'Please enter Base64 encoded OAuth credentials',
        'config.kiro.baseUrl': 'Base URL',
        'config.kiro.baseUrlPlaceholder': 'https://codewhisperer.{{region}}.amazonaws.com/generateAssistantResponse',
        'config.kiro.refreshUrl': 'Refresh URL',
        'config.kiro.refreshUrlPlaceholder': 'https://prod.{{region}}.auth.desktop.kiro.dev/refreshToken',
        ...
        'common.welcome': 'Welcome to Kiro2API Management Console!',
